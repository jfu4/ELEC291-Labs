; Configure the default AT89LP51RC2 in slow mode with input ports
...
myprogram:
    ...
    loadbyte(0x06, 0xff) ; ffh: CPU functions is Compatibility slow mode
    ...
    ; 0BH Tristate Ports
    loadbyte(0x0B, 0xff) ; 00h: I/O Ports start input mode after reset
